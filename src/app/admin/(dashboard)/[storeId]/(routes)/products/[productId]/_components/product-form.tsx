            ...
            <div className="mt-10">
              <div>
                {showButtons && !product.data.showPricing ? (
                  ...
                  <>
                    {product.data.hasAdditionalLink && (
                      <div className="max-w-9/12 flex flex-col items-center space-x-4 text-center">
                        <Link
                          className="w-full"
                          href={product.data.additionalLinkUrl}
                          target="_blank"
                    ...
                    {product.data.requiresVendorApproval && (
                      <div className="max-w-9/12 flex mt-4 flex-col items-center space-x-4 text-center">
                        <Link
                          className="w-full"

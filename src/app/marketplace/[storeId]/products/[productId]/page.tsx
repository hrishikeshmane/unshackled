...
const ProductPage =  () => {
    ...
    const product = api.product.getProductById.useQuery({id: String(productId)});
    const similarProducts = api.product.getApprovedProductsByStoreId.useQuery({storeId: String(storeId)});
    const similarProductsFiltered = similarProducts.data?.filter((p) => p.id !== productId);
  ...
  return (
    ...
    <div className='bg-white'>
        <div className='mx-auto max-w-2xl px-4 py-2 sm:py-4 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8'>
          {/* Product Details */}
          <div className='lg:max-w-lg lg:self-end'>
            ...
            <div className='mt-4 flex flex-col gap-1'>
              <h1 className='text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl'>
                <span className='text-primary'>{product.data.name}</span> {!!product.data.isFeatured ? (
            <Badge
                variant="outline"
            ...
            <section className='mt-4'>
              ...
              <div className='mt-6 flex items-center'>
                ...
                <div className='ml-4 border-l text-sm text-muted-foreground border-gray-300 pl-4'>
      ...
      { similarProductsFiltered && similarProductsFiltered?.length > 0 ?
        <ProductsReel products={similarProductsFiltered} title='Similar Products' />  :
        null
      }
      </div>        
      <div>

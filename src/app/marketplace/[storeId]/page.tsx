...
const StorePage = async ({params}: StoreParams) => {
    ...
    const billboard = await api.billboard.getBillboardsByStoreId({storeId: params.storeId});
    const products = await api.product.getApprovedProductsByStoreId({storeId: params.storeId});

...
import { SendRefrenceForm } from "~/components/landing-page/convertkit-forms";
      ...
      <section className="mx-auto flex w-full max-w-7xl flex-col justify-center gap-4 rounded-lg py-28">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex basis-1/3 scale-75 items-center justify-center md:scale-100">
            <Image
              src="https://github.com/hrishikeshmane/unshackled-asstets/blob/main/references/references.png?raw=true"
              alt="Soundarya"
              width={700}
              height={700}
            />
